...
bot.on('chat', (username, message) => {
  if (username == 'SALVATOR_505') {
    if (message == '1kovla botm') {
   
      continue_digging=true;
      dig()
      bot.chat("/is trust SALVATOR_505")
